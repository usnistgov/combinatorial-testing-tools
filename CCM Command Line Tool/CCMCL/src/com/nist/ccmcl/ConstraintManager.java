...
public class ConstraintManager {
     ...
     public static Boolean isVariableValue(String text) {
         ...
         if (Tools.isNumeric(text)) return true;
         if (text.toUpperCase().equals(Boolean.toString(true).toUpperCase()) || text.toUpperCase().equals(Boolean.toString(false).toUpperCase())) return true;
     ...
     public static Boolean isValidParameterValue(String text, Parameter anterior)
     {
         ...
         if (p.contains(Tools.WithoutQuoations( text.trim()))) return true;
         return false;
     }
