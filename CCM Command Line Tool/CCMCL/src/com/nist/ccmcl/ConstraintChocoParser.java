...
/* Generated By:JavaCC: Do not edit this line. ConstraintChocoParser.java */
...
//   private List list;
   ...
   public ConstraintChocoParser (String constraint, HashMap paramsMap, Constants choc) {
      this(new StringReader (constraint));
  ...
  public ConstraintChocoParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public ConstraintChocoParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new ConstraintChocoParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public ConstraintChocoParser(java.io.Reader stream) {
  ...
  public ConstraintChocoParser(ConstraintChocoParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(ConstraintChocoParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
